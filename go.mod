...
require (
	github.com/google/go-containerregistry/pkg/authn/k8schain v0.0.0-20220818132625-771a9b447104
	github.com/tektoncd/resolution v0.0.0-20220811144050-b9c69d5f8550
)
